...
const ResumeEnhancer = () => {
    ...
    return (<div className="resume-enhancer">
      ...
      <div className="resume-inputs">
        ...
        <label>
          Contact Info:
          <input type="text" name="contactInfo" value={resume.contactInfo} onChange={handleChange}/>
        </label>
        <label>
          Skills:
          <textarea name="skills" value={resume.skills} onChange={handleChange}/>
        </label>
        <label>
          Experience:
        ...
        <label>
          Education:
          <textarea name="education" value={resume.education} onChange={handleChange}/>
        </label>
        <label>
          Certifications:
          <textarea name="certifications" value={resume.certifications} onChange={handleChange}/>
        </label>
        <label>
          Projects:
          <textarea name="projects" value={resume.projects} onChange={handleChange}/>
        </label>
      </div>
      ...
      <div className="chat-gpt-enhancement">
        <label>
          ...
          <textarea value={chatGptInput} onChange={(e) => setChatGptInput(e.target.value)} placeholder="For example: 'Improve my experience section' or 'Suggest more impactful skills to add.'"/>
        </label>
        <button onClick={handleEnhanceResume}>Enhance Resume</button>
      </div>

      {enhancedResume && (<div className="enhanced-resume">
