      ...
      <Container sx={{
        ...
        <Stack spacing={2} useFlexGap sx={{ alignItems: 'center', width: { xs: '100%', sm: '70%' } }}>
          <Typography variant="h1" sx={{
            ...
            Stand out with&nbsp;smarter resumes.&nbsp;
          ...
          <Typography sx={{
            ...
            ResumePilot is an AI-powered resume and cover letter builder designed to help you
            create tailored, professional application materials in minutes! ResumePilot simplifies
            the job application process and helps you stand out in competitive job markets.
          </Typography>
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} useFlexGap sx={{ pt: 2, width: { xs: '100%', sm: '350px' } }}>
            <InputLabel htmlFor="email-hero" sx={visuallyHidden}>
              Email
            </InputLabel>
            <TextField id="email-hero" hiddenLabel size="small" variant="outlined" aria-label="Enter your email address" placeholder="Your email address" fullWidth slotProps={{
            htmlInput: {
                autoComplete: 'off',
